...
@Entity
@Table(name = "administrative_contact")
public class AdministrativeContact {
    ...
    @Column(name = "administrative_contact_email", nullable = true)
    private String administrativeContactEmail;
    ...
    public String getAdministrativeContactEmail() {
        return administrativeContactEmail;
    }

    public void setAdministrativeContactEmail(String administrativeContactEmail) {
        this.administrativeContactEmail = administrativeContactEmail;
    }
